...
#define DRE_SWAP_MEMBER(memberName) std::swap((memberName), (rhs.memberName))
...
#define DRE_RELEASE
    ...
    #define DRE_DEBUG_ONLY(exp) exp
    #define DRE_RELEASE_ONLY(exp)
    #define DRE_DEBUG_OR_RELEASE(deb, rel) deb
...
#else
    #define DRE_DEBUG_ONLY(exp)
    #define DRE_RELEASE_ONLY(exp) exp
    #define DRE_DEBUG_OR_RELEASE(deb, rel) rel
